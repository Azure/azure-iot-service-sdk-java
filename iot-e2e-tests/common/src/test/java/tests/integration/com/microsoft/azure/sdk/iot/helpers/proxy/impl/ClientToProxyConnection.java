...
import static tests.integration.com.microsoft.azure.sdk.iot.helpers.proxy.impl.ProxyUtils.shouldRemoveHopByHopHeader;
...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest>
{
    ...
    private void stripHopByHopHeaders(HttpHeaders headers) {
        ...
        for (String headerName : headerNames) {
            if (shouldRemoveHopByHopHeader(headerName)) {
