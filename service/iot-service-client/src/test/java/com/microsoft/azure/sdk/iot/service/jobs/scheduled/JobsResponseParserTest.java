...
public class JobsResponseParserTest
{
    ...
    public void gettersSucceed() throws ParseException
    {
        ...
        Helpers.assertDateWithError(jobsResponseParser.getCreatedTimeDate(),"2017-06-21T10:47:33.798692Z");
        Helpers.assertDateWithError(jobsResponseParser.getStartTimeDate(),"2017-06-21T16:47:33.798692Z");
        Helpers.assertDateWithError(jobsResponseParser.getEndTimeDate(),"2017-06-21T20:47:33.798692Z");
        ...
        assertNotNull(jobsResponseParser.getDeviceJobStatistics());
    ...
    public void gettersSucceedQueryResponse() throws ParseException
    {
        ...
        assertEquals("validDeviceID", jobsResponseParser.getDeviceId());
        assertEquals("jobName", jobsResponseParser.getJobId());
        Helpers.assertDateWithError(jobsResponseParser.getCreatedTimeDate(),"2017-07-11T23:55:14.0580263Z");
        Helpers.assertDateWithError(jobsResponseParser.getStartTimeDate(),"2017-07-11T23:55:12.0052Z");
        Helpers.assertDateWithError(jobsResponseParser.getEndTimeDate(),"2017-07-11T23:56:52.0052Z");
        ...
        assertNull(jobsResponseParser.getDeviceJobStatistics());
