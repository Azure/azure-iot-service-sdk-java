...
public class RegistryIdentityParserTest
{
    ...
    //Tests_SRS_DEVICE_PARSER_34_002: [This constructor shall create a RegistryIdentityParser object based off of the provided json.]
    @Test
    public void fromJsonWithSelfSignedAuthentication()
    {
        ...
        //act
        RegistryIdentityParser parser = new RegistryIdentityParser(json);
    ...
    {
        //act
        new RegistryIdentityParser(null);
    }
    ...
    {
        //act
        new RegistryIdentityParser("");
    }

    //Tests_SRS_DEVICE_PARSER_34_006: [If the provided json cannot be parsed into a RegistryIdentityParser object, an IllegalArgumentException shall be thrown.]
    @Test (expected = IllegalArgumentException.class)
    public void constructorThrowsForInvalidJson()
    {
        ...
        //act
        new RegistryIdentityParser(json);
    }
