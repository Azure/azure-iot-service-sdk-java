...
public final class ScheduledJobsClientOptions
{
    ...
    /**
     * The http read timeout to a specified timeout, in seconds. A non-zero value specifies the timeout when reading from
    ...
    /**
     * The http connect timeout value, in seconds, to be used when connecting to the service. If the timeout expires
